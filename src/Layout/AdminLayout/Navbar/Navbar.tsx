...
export default function Navbar() {
	...
	const myProjectsItem = navbarItem.filter(
		(item) => item.title === 'Back to My Projects',
	)
	const gameDetailsItems = navbarItem.filter(
		(item) => item.title !== 'Back to My Projects',
	)
	...
	return (
		<Box sx={{ display: 'flex' }}>
			...
			<Drawer variant="permanent" open={true}>
				<Box
					sx={{ px: 2.5, py: 3, display: 'inline-flex', cursor:'pointer' }}
